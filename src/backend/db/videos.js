...
export const videos = [
  ...
  },
  {
    ...
    title:
      "Give Your Cinnamon Desktop Fresh And Elegant Look With Orchis GTK Theme",
    views: "122k",
    cartgory: "Customization",
    description:
  ...
  },
  {
    ...
    views: "172k",
    cartgory: "Distros",
    description: "In this lengthy video, I go over some of the changes I would make in Linux Mint if I were using it as my daily driver.  I don't make drastic changes.  I just tweak some of the tools that are already there.",
    creator: "Distro Tube",
  },
];
